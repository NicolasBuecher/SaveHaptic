...
var BABYLON;
(function (BABYLON) {
    var TestMaterialDefines = (function (_super) {
        __extends(TestMaterialDefines, _super);
        function TestMaterialDefines() {
            _super.call(this);
        ...
        return TestMaterialDefines;
    }(BABYLON.MaterialDefines));
    var TestMaterial = (function (_super) {
        __extends(TestMaterial, _super);
        function TestMaterial(name, scene, options) {
            var _this = this;
            ...
            this.albedoColor = options.albedoColor || new BABYLON.Color3(0.8, 0.2, 0.6);
            this.microsurface = options.microsurface || 0.0;
            this.reflectivity = options.reflectivity || 0.5;
            this.specularColor = options.specularColor || new BABYLON.Color3(1.0, 1.0, 1.0);
            this.glossiness = options.glossiness || 50.0;
            this.AOPower = options.AOPower || 1.0;
            this.indirectLightPower; // Récupérer automatiquement = options.indirectLightPower || 0.6;
            this.lightSize; // Récupérer automatiquement =  5.0;
            this.albedoTexture = options.albedoTexture;
            this.microsurfaceTexture = options.microsurfaceTexture;
            this.reflectivityTexture = options.reflectivityTexture;
            this.cameraPosition; // Récupérer automatiquement
            ...
            this._defines = new TestMaterialDefines();
            this._cachedDefines = new TestMaterialDefines();
        ...
        Object.defineProperty(TestMaterial.prototype, "useLogarithmicDepth", {
            get: function () {
        ...
        TestMaterial.prototype.needAlphaBlending = function () {
        ...
        TestMaterial.prototype.needAlphaTesting = function () {
            return this.diffuseTexture != null && this.diffuseTexture.hasAlpha;
        };
        TestMaterial.prototype._shouldUseAlphaFromDiffuseTexture = function () {
            return this.diffuseTexture != null && this.diffuseTexture.hasAlpha && this.useAlphaFromDiffuseTexture;
        };
        TestMaterial.prototype.getAlphaTestTexture = function () {
            return this.diffuseTexture;
        };
        // Methods   
        TestMaterial.prototype._checkCache = function (scene, mesh, useInstances) {
            if (!mesh) {
                return true;
            }
        ...
        TestMaterial.prototype.isReady = function (mesh, useInstances) {
            if (this.isFrozen) {
            ...
            if (scene.texturesEnabled) {
                ...
                if (this.albedoTexture && TestMaterial.AlbedoTextureEnabled) {
                    if (!this.albedoTexture.isReady()) {
                        return false;
                    }
                    else {
                        needUVs = true;
                        this._defines.ALBEDOTEXTURE = true;
                    }
                }
                ...
                if (this.diffuseTexture && TestMaterial.DiffuseTextureEnabled) {
                ...
                if (this.ambientTexture && TestMaterial.AmbientTextureEnabled) {
                ...
                if (this.opacityTexture && TestMaterial.OpacityTextureEnabled) {
                ...
                if (this.reflectionTexture && TestMaterial.ReflectionTextureEnabled) {
                ...
                if (this.emissiveTexture && TestMaterial.EmissiveTextureEnabled) {
                ...
                if (this.lightmapTexture && TestMaterial.LightmapTextureEnabled) {
                ...
                if (this.specularTexture && TestMaterial.SpecularTextureEnabled) {
                ...
                if (scene.getEngine().getCaps().standardDerivatives && this.bumpTexture && TestMaterial.BumpTextureEnabled) {
                ...
                if (this.refractionTexture && TestMaterial.RefractionTextureEnabled) {
            ...
            if (TestMaterial.FresnelEnabled) {
                // Fresnel
            ...
            if (!this._defines.isEqual(this._cachedDefines)) {
                ...
                //var shaderName = "./shaders/customDefault2";
                //var shaderName = "./shaders/hapVizPBR_v0.5";
...
//                attribs = ["position"];
            ...
            if (mesh) {
                if (!mesh._materialDefines) {
                    mesh._materialDefines = new TestMaterialDefines();
                }
                this._defines.cloneTo(mesh._materialDefines);
            }
            return true;
        };
        TestMaterial.prototype.unbind = function () {
        ...
        TestMaterial.prototype.bindOnlyWorldMatrix = function (world) {
            this._effect.setMatrix("world", world);
        };
        TestMaterial.prototype.bind = function (world, mesh) {
            var scene = this.getScene();
            // Matrices        
            ...
            if (scene.getCachedMaterial() !== this) {
                ...
                if (scene.texturesEnabled) {
                    ...
                    if (this.bumpTexture && scene.getEngine().getCaps().standardDerivatives && TestMaterial.BumpTextureEnabled) {
        ...
        TestMaterial.prototype.getAnimatables = function () {
            var results = [];
        ...
        TestMaterial.prototype.dispose = function (forceDisposeEffect, forceDisposeTextures) {
        ...
        TestMaterial.prototype.clone = function (name) {
            var _this = this;
            return BABYLON.SerializationHelper.Clone(function () { return new TestMaterial(name, _this.getScene()); }, this);
        };
        TestMaterial.prototype.serialize = function () {
            return BABYLON.SerializationHelper.Serialize(this);
        };
        // Statics
        TestMaterial.Parse = function (source, scene, rootUrl) {
            return BABYLON.SerializationHelper.Parse(function () { return new TestMaterial(source.name, scene); }, source, scene, rootUrl);
        };
        // Flags used to enable or disable a type of texture for all Test Materials

        ////////////
        // CUSTOM //
        ////////////

        TestMaterial.AlbedoTextureEnabled = true;

        /////////
        // END //
        /////////

        TestMaterial.DiffuseTextureEnabled = true;
        TestMaterial.AmbientTextureEnabled = true;
        TestMaterial.OpacityTextureEnabled = true;
        TestMaterial.ReflectionTextureEnabled = true;
        TestMaterial.EmissiveTextureEnabled = true;
        TestMaterial.SpecularTextureEnabled = true;
        TestMaterial.BumpTextureEnabled = true;
        TestMaterial.FresnelEnabled = true;
        TestMaterial.LightmapTextureEnabled = true;
        TestMaterial.RefractionTextureEnabled = true;
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "diffuseTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "ambientTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "opacityTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "reflectionTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "emissiveTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "specularTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "bumpTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "lightmapTexture", void 0);
        __decorate([
            BABYLON.serializeAsTexture()
        ], TestMaterial.prototype, "refractionTexture", void 0);
        __decorate([
            BABYLON.serializeAsColor3("ambient")
        ], TestMaterial.prototype, "ambientColor", void 0);
        __decorate([
            BABYLON.serializeAsColor3("diffuse")
        ], TestMaterial.prototype, "diffuseColor", void 0);
        __decorate([
            BABYLON.serializeAsColor3("specular")
        ], TestMaterial.prototype, "specularColor", void 0);
        __decorate([
            BABYLON.serializeAsColor3("emissive")
        ], TestMaterial.prototype, "emissiveColor", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "specularPower", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useAlphaFromDiffuseTexture", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useEmissiveAsIllumination", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "linkEmissiveWithDiffuse", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useReflectionFresnelFromSpecular", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useSpecularOverAlpha", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useReflectionOverAlpha", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "disableLighting", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useParallax", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useParallaxOcclusion", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "parallaxScaleBias", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "roughness", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "indexOfRefraction", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "invertRefractionY", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useLightmapAsShadowmap", void 0);
        __decorate([
            BABYLON.serializeAsFresnelParameters()
        ], TestMaterial.prototype, "diffuseFresnelParameters", void 0);
        __decorate([
            BABYLON.serializeAsFresnelParameters()
        ], TestMaterial.prototype, "opacityFresnelParameters", void 0);
        __decorate([
            BABYLON.serializeAsFresnelParameters()
        ], TestMaterial.prototype, "reflectionFresnelParameters", void 0);
        __decorate([
            BABYLON.serializeAsFresnelParameters()
        ], TestMaterial.prototype, "refractionFresnelParameters", void 0);
        __decorate([
            BABYLON.serializeAsFresnelParameters()
        ], TestMaterial.prototype, "emissiveFresnelParameters", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useGlossinessFromSpecularMapAlpha", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "maxSimultaneousLights", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "invertNormalMapX", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "invertNormalMapY", void 0);
        __decorate([
            BABYLON.serialize()
        ], TestMaterial.prototype, "useLogarithmicDepth", null);
        return TestMaterial;
    }(BABYLON.Material));
    BABYLON.TestMaterial = TestMaterial;
})(BABYLON || (BABYLON = {}));